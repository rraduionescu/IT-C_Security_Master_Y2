...
//		void dispElem();
//		Array& operator+(Array&); //  array + array
//		Array& operator+(float); // array + float
//		friend Array& operator+(float, Array&); // commutativity of add operation
//		float& operator[](int);
//		float avg();
//	};
//	Array::Array() {
