...
//		SHA_CTX ctx;
//
//		// 1st version of SHA1 using entire content of the input file ( > 20 bytes)
...
//    		}
//			
//			// 2nd version for input buffer addChars (20 bytes as length)
...
//			printf("\n");
//			
//			// 3rd version using addChars as input buffer (20 bytes length)
