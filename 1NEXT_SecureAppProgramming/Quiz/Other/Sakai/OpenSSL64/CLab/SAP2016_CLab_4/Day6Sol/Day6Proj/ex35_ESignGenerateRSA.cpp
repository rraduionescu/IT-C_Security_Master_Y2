...
//
//		RSA_private_encrypt(sizeof(finalDigest), buf, e_data, apriv, RSA_PKCS1_PADDING); // encryption of the message digest
//
//		fwrite(e_data, RSA_size(apriv), 1, fdst); // e-sign saved into file
//
//		fclose(fdst);
//			
//		free(e_data);
