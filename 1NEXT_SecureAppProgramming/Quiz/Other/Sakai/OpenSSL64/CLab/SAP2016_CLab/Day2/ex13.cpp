...
//			} else {
//				printf("\n Unknown option \n Encryption examples: \n \
//					UseCrypto.exe -e -ecb fClear fEnc \n \
//					UseCrypto.exe -e -cbc fClear fEnc \n\n \
//					Decryption examples: \n \
//					UseCrypto.exe -d -ecb fEnc fRestored \n \
//					UseCrypto.exe -d -cbc fEnc fRestored \n");
//				return 2;
//			}
//		}
//		fclose(fDst);
